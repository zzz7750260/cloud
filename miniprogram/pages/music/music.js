...
Page({
  ...
  data: {
    ...
    musicControl:false,   //声明音乐控件
    musicSrc:null,        //声明播放音乐地址
  },
  ...
  getMusicList:function(){
    ...
    wx.request({
      ...
      //  rn:100,
      //},
      url: 'https://www.idc-new.com/laravelAudio/public/outsideApi/search/' + voiceValue,
      data:{
  ...
  autoPlayMode:function(arr){
    ...
    //将对应的信息进行存储
    this.setData({
      musicPlayId:selectArr['rid'],
      musicName:selectArr['name'],
      musicSinger: selectArr['artist']
    })
    ...
    this.getMusicUrl(this.data.musicPlayId)
  ...
  getMusicInfo(){
    ...
    wx.request({
      //url: 'http://www.kuwo.cn/api/www/music/musicInfo', //仅为示例，并非真实的接口地址
      //data: {
      //  mid: musicPlayId
      //},
      url: 'https://www.idc-new.com/laravelAudio/public/outsideApi/musicInfo/' + musicPlayId,
      data:{
  ...
  getMusicUrl:function(id){
    ...
    wx.request({
      ...
      //  from:'web'
      //},
      url:'https://www.idc-new.com/laravelAudio/public/outsideApi/music/'+id,
      data:{
